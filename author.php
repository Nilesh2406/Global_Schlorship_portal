      ...
      <div class="container">
        <div class="row">
            ...
            <?php
                    ...
                    ?>
                  <h2 class="page-heading">Issued BY<?php echo $row1['username'];?></h2>
                   ...
                   <?php
                           ...
                           LEFT JOIN user ON post.author = user.user_id WHERE post.author={$auth_id} ORDER BY post.post_id DESC LIMIT {$offset},{$limit}";
